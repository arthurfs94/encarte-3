...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable().authorizeRequests()
			...
			.antMatchers(HttpMethod.GET,"/productregistration").permitAll()
			.antMatchers(HttpMethod.GET,"/listaencartesproducts").permitAll()
			.antMatchers(HttpMethod.GET,"/listaproductsencarte/**").permitAll()
			.antMatchers(HttpMethod.GET,"/alterarencartes/**").permitAll()
			.antMatchers(HttpMethod.GET,"/excluirencartes/**").permitAll()
			.antMatchers(HttpMethod.GET,"/alterarproducts/**").permitAll()
			.antMatchers(HttpMethod.GET,"/excluirproducts/**").permitAll()
			.antMatchers(HttpMethod.GET,"/listaEncartesAlterar/**").permitAll()
			.antMatchers(HttpMethod.GET,"/listaProductsAlterar/**").permitAll()
			.antMatchers(HttpMethod.GET,"/listaencartesexcluir/**").permitAll()
			.antMatchers(HttpMethod.GET,"/listaproductsexcluir/**").permitAll()
			.antMatchers(HttpMethod.GET,"/telaCadastroDeMercados/**").permitAll()
